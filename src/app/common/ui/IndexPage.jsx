        ...
        <div className="flex items-center justify-center min-h-screen bg-pink-200">
            ...
            <main className="flex flex-col items-center justify-center w-full flex-1 px-5 md:px-20 text-center">
                ...
                <div className="mt-6 md:mt-8 rounded-full shadow-lg bg-pink-100">
                    <img src="/media/image/cake.png" alt="Birthday Cake" className="w-48 h-48 md:w-64 md:h-64 p-4 md:p-5"/>
                </div>
                <div className="mt-4 md:mt-6">
                    <button className="px-6 md:px-8 py-3 md:py-4 bg-pink-600 text-white rounded-full shadow-lg transform transition hover:scale-105" onClick={() => push("/proposal")}>
