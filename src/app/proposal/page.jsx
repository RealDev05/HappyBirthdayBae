...
export default function Page() {
  ...
  const saidYesStyle =
    "px-6 py-3 bg-green-500 text-white rounded-full shadow-lg transform transition hover:scale-105 md:px-8 md:py-4";
  ...
  return (
    <div className="flex items-center justify-center font-['Poppins'] min-h-screen bg-pink-200 relative overflow-hidden">
      <main className="flex flex-col items-center justify-center w-full flex-1 px-5 md:px-20 text-center">
        <h2 className="text-3xl md:text-4xl -mt-5 font-bold text-pink-600">
          Before that,
        </h2>
        ...
        <p className="mt-3 text-xl md:text-2xl text-pink-700">
          You're the most amazing person in my life, and I can't imagine my life
          without you!
        </p>
